        ...
        <div className='h-full glass text-white'>
            ...
            <div className='flex flex-col items-center pb-14'>
                <div className='glass rounded-15 flex flex-col items-center w-3/4 py-14'>
                    ...
                    <span className='text-4xl font-thin pt-4'>Maintenance</span>
                </div>
                <div className='glass rounded-15 flex flex-col items-center w-3/4 py-14 my-10'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={0.4} stroke="currentColor" className="w-32 h-32">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
                    </svg>
                    <span className='text-4xl font-thin pt-4'>Create</span>
                </div>
                <div className='glass rounded-15 flex flex-col items-center w-3/4 py-14'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={0.4} stroke="currentColor" className="w-32 h-32">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42" />
                    </svg>
                    <span className='text-4xl font-thin pt-4'>UI Design</span>
                </div>
            </div>
        </div>
    );
